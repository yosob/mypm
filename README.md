...
- ⏰ 主动提醒：任务截止日每天定时报（7 天窗口内**每天提醒**，≤3 天重点档加急标注，逾期红色档；阈值可配）+ **任意定时器**（「下午3点提醒我X」一次性、「每周一提醒我Y」周期，AI 直接设置/查询/取消）
...
|---|---|---|
| `port` | `8787` | 看板端口 |
| `remindDays` | `7` | 提前 N 天进入每日提醒窗口（窗口内每天提醒直到完成） |
| `remindHighlightDays` | `3` | 到期前 N 天进入重点档（❗+橙色卡片，逾期为红色档） |
